    ...
    return (
        <div className="grid grid-cols-4 gap-x-2 gap-y-4 p-4">
            {blocks.map((block) => (
                ...
                >
                    {/* Icon Box */}
                    <div className="w-full aspect-square flex items-center justify-center border border-gray-200 rounded-lg 
                              group-hover:border-primary group-hover:shadow-sm transition">
